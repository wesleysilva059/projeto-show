            ...
            <div class="container-fluid limit">
                ...
                <div class="row">
                    <div class="col-sm-5 pr-0 pr-sm-4 u-mb-25">
                        <label class="item-box-a-selecionar item-box-selecionado u-mb-15" onclick="marca_radio(this, 'forma_pagamento');$('.contribuicao_pagamento').hide();$('.contribuicao_pagamento_boleto').show();">Cartão de Crpedito
