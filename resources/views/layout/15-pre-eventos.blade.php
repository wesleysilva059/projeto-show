                    ...
                    <div class="col-sm-9 pl-0 pl-sm-4">
                        <div class="row">
                            ...
                            <div class="col-md-7 text-right">
                                <a href="#" class="u-b-radius-3 font-weight-bold u-fs-16 text-white d-inline-block cor-bg-azul-show u-px-30 u-py-10 u-mr-10 transition">MEUS PRÉ-EVENTOS</a>
                                <a href="#" class="u-b-radius-3 font-weight-bold u-fs-16 u-c-gs-75 d-inline-block u-b-gs-230 u-px-30 u-py-10 transition hover-btn-blue">PRÉ-EVENTOS GERAIS</a>
                            </div>
                        </div>
                        ...
                        <div class="bg-white sombra-leve u-pt-50 u-pb-25 u-px-30 u-mb-25">
                            <div class="row">
                                ...
                                <div class="col-md-4 text-center">
                                    <div class="cor-azul-show u-fs-16 u-mb-25"><i class="far fa-clock u-mr-5"></i> Aguardando liberação ...</div>
