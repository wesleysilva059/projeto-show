        ...
        <main class="main-perfil2 u-pt-100">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 u-mb-50">
                                <div class="u-h-160 bg-cover-center u-b-radius-5" style="background-image: url('{{assets('images/sistema/empresas-transporte-thumb.png')}}');"></div>
                            </div>
            ...
            <div class="u-pt-40 u-pb-30 bg-cover-center" style="background-image: url('{{assets('images/sistema/casas-de-show-listagem-bg-cadastre.jpg')}}');">
                <div class="container-fluid text-center u-fs-36 text-white">
                    CADASTRE SUA <span class="font-weight-bold">EMPRESA DE TRANSPORTE</span> <a class="btn-saiba-mais d-inline-block ml-3 mt-0 position-relative u-top-minus-5" href="#">CADASTRAR</a>
                </div>
            </div>
        </main>
