            ...
            <div class="container-fluid limit pt-5">
                <div class="row">
                    ...
                    <div class="col-sm-9 pl-0 pl-sm-4">
                        ...
                        <div class="spacer-linha-fina u-mb-45 u-pt-25"></div>
                        <div class="row u-my-45">
                            <div class="col-sm-8 u-fs-24 u-c-gs-95 u-pt-15">
                                Não encontrou o seu artista favorito? <strong>Indique ele aqui</strong>
                            </div>
                            <div class="col-sm-4">                                
                                <a class="section-fase-destaque-btn sombra-leve ui-mb-0" href="#" >INDIQUE UM ARTISTA</a>
                            </div>
                        </div>
                        <div class="spacer-linha-fina u-mb-45"></div>

                       <div class="bg-white sombra-leve p-5 u-mb-100 text-center">
                           <div class="cor-azul-show u-fs-25 text-center mb-5">Esse evento já existe!</div>
                           <div class="row">
                           ...
                           <a href="#" class="btn-cinza">PARTICIPAR</a>
                           <a class="section-fase-destaque-btn sombra-leve ml-0 ml-sm-4 my-4" href="#" >PEDIR NOVO EVENTO</a>
                       </div>
