                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="banner-home-frase ui-pt-70">
                           <span class="font-weight-bold">CADASTRE UMA EMPRESA DE TRANSPORTE</span><br/>
                            PARA A PLATAFORMA
                        </div>
                    </div>
        ...
        <main class="main-perfil2 u-py-100">
            <div class="container-fluid limit">
                ...
                <form id="form-cadastro" action="#" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="text" name="nome_empresa" class="input-text" placeholder="Nome da Empresa de Transporte"/>
                        </div>
                    ...
                    <div class="text-center u-mb-100">
                        <a class="btn-saiba-mais sombra-leve d-inline-block mt-2" href="javascript:;" onclick="$('#form-cadastro').submit();">CADASTRAR EMPRESA DE TRANSPORTE</a>
                    </div>
                </form>
