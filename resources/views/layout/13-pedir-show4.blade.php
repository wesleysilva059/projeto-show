            ...
            <div class="container-fluid limit pt-5">
                <div class="row">
                    ...
                    <div class="col-sm-9 pl-0 pl-sm-4">
                        ...
                        <div class="row u-mb-35">
                            <div class="col-sm-4 pr-0 pr-sm-3 u-mb-15">
                                <label class="item-box-a-selecionar" onclick="marca_radio(this, 'local');">Pista - R$35,00
                        ...
                        <img src="{{assets('images/sistema/pista.jpg')}}" alt="" class="w-100 u-mb-35">

                        <div class="u-fs-36 cor-bg-azul-show text-white text-center u-b-radius-3 u-py-10 u-mb-35">Sua contribuição será de - R$35,00</div>


                        <div class="row">
                            <div class="col-sm-6 pr-0 pr-sm-3">
                                <label class="item-box-a-selecionar u-mb-15" onclick="marca_radio(this, 'forma_pagamento');$('.contribuicao_pagamento').hide();$('.contribuicao_pagamento_boleto').show();">Boleto
                        ...
                        <div class="u-mb-25 contribuicao_pagamento contribuicao_pagamento_boleto">
                            <div class="row">
                                <div class="col-sm-6 pr-0 pr-sm-3">
                                    <div class="row">
                                        <div class="col-sm-6 pr-0 pr-sm-3 u-mb-15">
                                            <a href="#" class="u-py-15 bg-e6 u-b-radius-5 u-fs-18 u-c-gs-70 d-block text-center">Visualizar boleto</a>
                                        </div>
                                        <div class="col-sm-6 u-mb-15">
                                            <a href="#" class="u-py-15 bg-e6 u-b-radius-5 u-fs-18 u-c-gs-70 d-block text-center">Visualizar boleto</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="text-center u-py-50 u-fs-22 u-c-gs-70 mx-0 mx-sm-5">Fique tranquilo, seus dados pessoais ficarão registrados em nosso sistema e só haverá débito quando a meta do show que você escolheu for alcançada</div>
