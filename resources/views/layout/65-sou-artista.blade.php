...
<html lang="en">
    ...
    <body>
        ...
        <section class="banner-sou-artista">
            <div class="container-fluid limit">
                ...
                <div class="text-center">
                    <a class="btn-saiba-mais d-inline-block" href="#">QUERO ME CADASTRAR</a>
        ...
        <section class="sou-fa-ja-participaram bg-branco-quadriculado">
            <div class="ja-assistiram-titulo-cinza ui-w-max-700 mb-5 pb-5">
                ARTISTAS QUE <span class="font-weight-bold">JÁ PARTICIPARAM</span> DO <span class="f-zul-sign">Escolha Seu Show</span>
            </div>
            ...
            <div id="slider-sou-fa">
                ...
                <div class="slider-sou-fa-card">
                    ...
                    <div class="slider-sou-fa-card-body">
                        ...
                        <div class="slider-sou-fa-card-perfil">Artista cadastrado na plataforma</div>
        ...
        <div class="container-fluid limit pb-5">
            <div class="como-funciona-titulo mb-5">SAIBA <span class="font-weight-bold">COMO SER ARTISTA</span> DA PLATAFORMA</div>
            <div class="como-pedir-video sombra-leve" style="padding-top: 20%;background-image:url('{{assets('images/sistema/como-ser-artista-video-capa.jpg')}}');">
