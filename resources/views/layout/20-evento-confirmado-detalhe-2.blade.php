                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 pl-0 pl-sm-4">
                        ...
                        <div class="bg-white sombra-leve u-py-20 u-px-30 u-mb-50 u-c-gs-100 u-fs-18">
                            <div class="row">
                                <div class="col-md-8 pt-0 pt-md-3 mb-3 mb-md-0 pr-0 pr-md-3">
                                ...
                                <div class="col-md-4 text-right">
                                    <div class="d-inline-block u-mb-15 u-b-gs-230 u-c-gs-100 u-py-10 u-px-15">
                                        <i class="fas fa-check-circle cor-azul-show"></i> Meta Atingida
                                    </div>
                                    <a class="btn-detalhes font-weight-bold mb-0" href="#">COMPRE AGORA</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="u-mb-100">
                            ...
                            <div class="bg-white sombra-leve u-pt-50 u-pb-25 u-px-30 u-mb-25">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-right">
                                        <div class="d-inline-block u-mb-15 u-b-gs-230 u-c-gs-100 u-py-10 u-px-15 u-fs-18">
                                            <i class="fas fa-check-circle cor-azul-show"></i> Meta Atingida
                                        </div>
                                        <a class="btn-detalhes font-weight-bold mb-0" href="#">COMPRE AGORA</a>
                                    </div>
