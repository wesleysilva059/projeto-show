        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="banner-home-frase ui-pt-145">
                    NUNCA FOI TÃO FÁCIL IR AO <span class="f-zul-sign">Show</span> DA SUA <span class="font-weight-bold">BANDA
                        PREFERIDA</span>
                </div>
            </div>
            <div class="col-sm-2"></div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-sm-2 vertical-middle-container">
                <div class="text-center w-100">
                    <a class="btn-saiba-mais d-inline-block my-md-0 my-5" href="{{route('sistema.fan.sou-fan')}}">SAIBA MAIS</a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-7 vertical-middle-container">
                <div>
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <span class="color-rgb-16-43-42 fs-21">Cadastre sua banda, e convide seus fãs para pedirem
                                seu show</span>
                        </div>
                        <div class="col-sm-5">
                            <div class="text-center w-100">
...
<section class="sou-produtor-home-section ">
    <div class="container-fluid limit position-relative">
        ...
        <div class="detalhes-produtor-home position-absolute">
            <img src="{{assets('/images/detalhes-produtor-home.png')}}" alt="">
        </div>
    </div>
...
<section class="como-funciona-section">
    <div class="container-fluid limit">
        ...
        <div class="como-funciona-video sombra-leve" style="padding-top: 20%;">
            <div class="text-center w-100">
