...
<!-- Banner principal da home -->
        <section class="banner-sou-fan">
            <div class="container-fluid limit">
                ...
                <div class="text-center">
                    ...
                    <a class="btn-outline-white d-inline-block ml-2" href="#como">COMO FUNCIONA</a>
                </div>
                ...
                <div id="slider-sou-fa">
                    ...
                    <div class="slider-sou-fa-card">
                        ...
                        <div class="slider-sou-fa-card-body">
                            ...
                            <div class="slider-sou-fa-card-descricao"><img src="{{assets('images/sistema/citacao.png')}}" class="slider-sou-fa-card-citacao"  alt="">A plataforma Escolha Seu Show é incrível. Fácil de usar, com vários shows disponíveis e consigo acessar pelo celular com acessibilidade.</div>
                        </div>
                    </div>
                    <?php }?>
                </div>   
        ...
        <div class="container-fluid limit pb-5" id="como">
